    ...
    <div class="row">
        <div class="small-16 large-11 columns">
            <div class="container" style="background-color: rgba(107, 63, 15, 0.63);
                ...
                <form action="<?php echo site_url('welcome/update_password/' . $user[0]['username']); ?>" method="POST" enctype="multipart/form-data">

                    <label>Old Password
                        <input type="password" name="old" id="old" required placeholder="Old password." aria-describedby="exampleHelpText" style="margin-top:1%;color: black;">
                    </label>
                    <?php
            ...
            <center>
                <input type="submit" value="Change" class="expanded lime-button">
            </center>
            </form>
