...
<div class="container-fluid">
        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class=""  style="float:left">
                    <h4 class="page-title">Edit  Advertise</h4>                    
                </div>                
    ...
    echo form_open_multipart('admin/advertise/edit/' . $editAdvertise['0']['advertise_id'], $formEdit);
    ?>
    <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    $dataTextarea = array(
                        ...
                        'cols' => '10',
                        'class' => 'form-control',
                        'value' => $editAdvertise['0']['advertise_name']
                    );
