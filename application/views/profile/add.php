            ...
            <div class="container" style="background-color: rgba(107, 63, 15, 0.63);
                ...
                <div class="row">
                    <h3>Account Details  <?php
                        if ($user[0]['image'] != "") {
                            echo '<img src=' . base_url() . $user[0]['image'] . ' height="100" width="100" style="float:right">';
                        }
                        ?></h3>
                </div>
                <form action="<?php echo site_url('welcome/update_profile/' . $user[0]['username']); ?>" method="POST" enctype="multipart/form-data">
                    <?php
                    ...
                    ?>
                    <label>Username
                        <input type="text" name="name" id="name" onchange="check_username();" value="<?php echo $user[0]['username']; ?>" readonly required placeholder="Please select a unique username. You may only use letters and numbers." aria-describedby="exampleHelpText" style="margin-top:1%;color: black;background-color: rgba(222, 216, 219, 0.25);">
                    </label>
                    ...
                    <label>Your Email Address
                        <input type="email" name="email" id="email" onchange="check_email();" value="<?php echo $user[0]['email']; ?>" required placeholder="We will send you an activation email so be sure to enter a valid and current address." aria-describedby="exampleHelpText" style="margin-top:1%;color: black;">
                    </label> 
                    ...
                    <label>Profile Picture
                        <input type="file" name="file" id="file" aria-describedby="exampleHelpText" style="margin-top:1%;color: black;">
                    </label>
                    <label>How did you find us?
                        <input type="text" name="find" id="find" required value="<?php echo $user[0]['how_find']; ?>" placeholder="Write anything from where you come, this will help us on site promoting." aria-describedby="exampleHelpText" style="margin-top:1%;color: black;">
                    </label>
            </div>
